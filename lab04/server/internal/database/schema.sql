...
INSERT IGNORE INTO users(id, username, password, firstname, lastname, email, extra) VALUES('18f0bcd3-d9b5-4310-98ee-031150d4f21e', 'admin', 'random-password', 'Dick', 'Hardt', 'admin@oauth.labs', 'flag{c2606225fce191368f89c013e9d38fc3c7d2f72f}');
