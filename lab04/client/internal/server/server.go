...
import (
	...
	"github.com/cyllective/oauth-labs/lab04/client/internal/assets"
	"github.com/cyllective/oauth-labs/lab04/client/internal/client"
	...
	"github.com/cyllective/oauth-labs/lab04/client/internal/controllers"
	"github.com/cyllective/oauth-labs/lab04/client/internal/middlewares"
	"github.com/cyllective/oauth-labs/lab04/client/internal/services"
	"github.com/cyllective/oauth-labs/lab04/client/internal/session"
)
...
func configureRoutes(r *gin.Engine) error {
...

	{
		...
		r.POST("/set-tokens", middlewares.NoCache(), c.SetTokens)
	}
