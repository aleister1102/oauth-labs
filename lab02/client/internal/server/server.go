...
import (
	...
	"github.com/cyllective/oauth-labs/lab02/client/internal/assets"
	"github.com/cyllective/oauth-labs/lab02/client/internal/client"
	"github.com/cyllective/oauth-labs/lab02/client/internal/config"
	"github.com/cyllective/oauth-labs/lab02/client/internal/constants"
	"github.com/cyllective/oauth-labs/lab02/client/internal/controllers"
	"github.com/cyllective/oauth-labs/lab02/client/internal/middlewares"
...
func configureRoutes(r *gin.Engine) error {
	...
	r.GET("/profile", middlewares.NoCache(), middlewares.TokensRequired(tokenService), func(c *gin.Context) {
		...
		tokens, err := tokenService.Get(session)
		if err != nil {
			panic(err)
		}
