...
import (
	...
	"github.com/cyllective/oauth-labs/lab02/server/internal/assets"
	...
	"github.com/cyllective/oauth-labs/lab02/server/internal/controllers"
	"github.com/cyllective/oauth-labs/lab02/server/internal/database"
	"github.com/cyllective/oauth-labs/lab02/server/internal/middlewares"
	"github.com/cyllective/oauth-labs/lab02/server/internal/redis"
	"github.com/cyllective/oauth-labs/lab02/server/internal/repositories"
...
func configureSessions(r *gin.Engine) error {
	...
	r.Use(sessions.Sessions(cfg.GetString("cookie.name"), store))
	return nil
}
