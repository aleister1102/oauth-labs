...
import (
	...
	"github.com/cyllective/oauth-labs/lab05/server/internal/assets"
	"github.com/cyllective/oauth-labs/lab05/server/internal/config"
	"github.com/cyllective/oauth-labs/lab05/server/internal/constants"
	"github.com/cyllective/oauth-labs/lab05/server/internal/controllers"
	"github.com/cyllective/oauth-labs/lab05/server/internal/database"
	"github.com/cyllective/oauth-labs/lab05/server/internal/middlewares"
...
func configureMiddlewares(r *gin.Engine) error {
	...
	r.Use(cors.New(cors.Config{
		...
		AllowOriginFunc: func(origin string) bool {
			return origin == "null" || origin == "https://client-05.oauth.labs" || origin == "http://127.0.0.1:3001"
		},
		MaxAge: 12 * time.Hour,
	}))
	return nil
